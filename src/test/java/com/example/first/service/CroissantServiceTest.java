...
//        Croissant expectedResult = new Croissant(1L, "Croissant", 2.55, Set.of(new Ingredient()));
        ...
        when(croissantRepository.exists(Example.of(expectedResult))).thenReturn(false);
        when(croissantRepository.save(expectedResult)).thenReturn(new Croissant(1L, "Croissant", 2.55, Set.of(new Ingredient())));
